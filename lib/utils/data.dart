...
const String baseUrl = 'https://avatars.dicebear.com/api';
...
const Map styles = {
  'adventurer': {
    ...
    'eyebrows': [
      "variant10, variant09, variant08, variant07, variant06, variant05, variant04, variant03, variant02, variant01"
    ],
    'mouth': [
    ...
    'accessoires': [
      "sunglasses, glasses, smallGlasses, mustache, blush, birthmark"
    ],
    'hair': [
    ...
    'skinColor': ["variant02, variant03, variant04, variant05"],
    'hairColor': [
      "red01, red02, red03, blonde01, blonde02, blonde03, brown01, brown02, black, gray, green, blue, pink, purple"
    ],
  }
};
